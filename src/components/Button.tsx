...
export const buttonVariants = cva(
	'inline-flex items-center justify-center h-12 md:h-16 px-10 text-lg transition-colors disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 border group relative',
	{
		variants: {
			variant: {
				'primary-dark': 'border-white bg-white hover:text-white hover:bg-transparent',
				'secondary-dark': 'border-white/30 text-white bg-transparent hover:border-white',
				'tertiary-dark': 'text-white h-auto md:h-auto border-none px-2 md:px-5',
				'primary-light': 'border-black bg-black text-white hover:text-black hover:bg-transparent',
				'secondary-light': 'border-black/30 bg-transparent hover:border-black',
				'tertiary-light': 'text-black h-auto md:h-auto border-none px-2 md:px-5',
			},
		},
		defaultVariants: {
